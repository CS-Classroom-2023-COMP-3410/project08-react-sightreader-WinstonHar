    ...
    function refresh_countdown() {
      ...
      if (countdown > 0) {
        if (countdownRef.current) {
          countdownRef.current.textContent = tunebook[0].getBeatsPerMeasure() - countdown + 1;
          $(countdownRef.current)
            .css({ 'font-size': '15em', opacity: 1.0 })
            .show()
            .animate({ opacity: '0' }, milliseconds_per_beat(current_qpm), 'swing', refresh_countdown);
        }
      } else {
        ...
        <div className="row-fluid controls">
          <div className="span12">
            ...
            <select id="file" ref={fileSelectRef}>
              ...
              {/* … (Include all your file options as in your original HTML.) */}
            </select>
