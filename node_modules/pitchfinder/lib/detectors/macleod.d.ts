import { ProbabalisticPitchDetector } from 'pitchfinder/lib/detectors/types';
...
export declare function Macleod(params?: Partial<MacleodConfig>): ProbabalisticPitchDetector;
