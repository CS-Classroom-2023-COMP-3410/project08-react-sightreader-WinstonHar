    ...
    var TuneBuilder = function(tune) {
      ...
      this.startNewLine = function(params) {
        ...
        var createStaff = function(params2) {
          ...
          if (params2.annotationfont) self.setLineFont("annotationfont", params2.annotationfont);
          if (params2.gchordfont) self.setLineFont("gchordfont", params2.gchordfont);
          if (params2.tripletfont) self.setLineFont("tripletfont", params2.tripletfont);
          if (params2.vocalfont) self.setLineFont("vocalfont", params2.vocalfont);
        ...
        if (tune.lines[tune.lineNum] === void 0) createLine(params);
        else if (tune.lines[tune.lineNum].staff === void 0) {
          tune.lineNum++;
          this.startNewLine(params);
        } else if (tune.lines[tune.lineNum].staff[tune.staffNum] === void 0) createStaff(params);
        else if (tune.lines[tune.lineNum].staff[tune.staffNum].voices[tune.voiceNum] === void 0) createVoice(params);
      ...
      this.isFirstLine = function(index) {
        for (var i = index - 1; i >= 0; i--) {
          if (tune.lines[i].staff !== void 0) return false;
        }
        return true;
      };
...
var require_tab_violin = __commonJS({
  "node_modules/abcjs/src/tablatures/instruments/violin/tab-violin.js"(exports, module) {
    ...
    Plugin.prototype.init = function(abcTune, tuneNumber, params) {
      ...
      this.tablature = new StringTablature(
        this.nbLines,
        this.linePitch
      );
    ...
    AbstractEngraver.prototype.addGraceNotes = function(elem, voice, abselem, notehead, stemHeight, isBagpipes, roomtaken) {
      ...
      for (i = 0; i < elem.gracenotes.length; i++) {
        ...
        var ret = createNoteHead(
          ...
          "noteheads.quarter",
          elem.gracenotes[i],
          { dir: "up", headx: -graceoffsets[i], extrax: -graceoffsets[i], flag, scale: gracescale * this.voiceScale, accidentalSlot }
        );
      ...
      self.prime = function() {
        ...
        return new Promise(function(resolve) {
          ...
          for (var key2 = 0; key2 < Object.keys(uniqueSounds).length; key2++) {
            ...
            allPromises.push(placeNote(audioBuffer, activeAudioContext().sampleRate, parts, uniqueSounds[k], self.soundFontVolumeMultiplier, self.programOffsets[parts.instrument], fadeTimeSec, self.noteEnd / 1e3));
          }
    ...
    (function() {
      ...
      function addNotes(midi, notePlacement, baseDuration2) {
        ...
        for (var i = 0; i < times.length; i++) {
          ...
          if (times[i] > lastTime) {
            var distance = (times[i] - lastTime) * baseDuration2;
